...
static const char *colorname[] = {
  "#353b45", /* hard contrast: #1d2021 / soft contrast: #32302f */
  "#e06c75",
  "#98c379",
  "#e5c07b",
  "#d19a66",
 ...
 */
static unsigned int mouseshape = XC_left_ptr;  /* theme default left_ptr */
...
static char *openurlcmd[] = { "/usr/bin/zsh", "-c", "st-urlhandler", "externalpipe", NULL };

static char *copyurlcmd[] = { "/usr/bin/zsh", "-c",
...
static char *copyoutput[] = { "/usr/bin/zsh", "-c", "st-copyout", "externalpipe", NULL };
...
static Shortcut shortcuts[] = {
  ...
  { TERMMOD,		          XK_m,		        changealpha,	  {.f = +2.00} },
